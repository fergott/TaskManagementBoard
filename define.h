...
void editBoard(List *board);              // Function to edit an item from the list
void editList(List *board);               // Function to edit a list from the board
...
Item *find_item(List *list, char *name); // Function helper to find an item by name for Task 3
